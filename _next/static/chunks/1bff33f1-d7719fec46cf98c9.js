  ...
  [3439],
  {
    37536: (t, e, i) => {
      ...
      class tk extends tf {
        ...
        _computeGridLineItems(t) {
          ...
          if ("top" === b)
            ...
            (l = (r = e - D) - k), (d = t.left), (u = t.right);
          }
          let E = (0, s.v)(m.ticks.maxTicksLimit, M),
            L = Math.max(1, Math.ceil(M / E));
          for (i = 0; i < M; i += L) {
      ...
      function tJ(t, e, i, a, n, r) {
        ...
        if ((t.beginPath(), r)) {
          let e = (P + D) / 2;
          if ((t.arc(o, l, u, P, e), t.arc(o, l, u, e, D), y > 0)) {
            let e = tK(S, D, o, l);
            t.arc(e.x, e.y, y, D, _ + s.H);
          }
          let i = tK(E, _, o, l);
          if ((t.lineTo(i.x, i.y), k > 0)) {
            let e = tK(E, O, o, l);
            t.arc(e.x, e.y, k, _ + s.H, O + Math.PI);
          }
          let a = (_ - k / g + (b + M / g)) / 2;
          if (
      ...
      class t7 extends tf {
        ...
        updateControlPoints(t, e) {
          ...
          if (
            ...
            (0, s.am)(this._points, i, t, a, e), (this._pointsUpdated = !0);
          }
        }
        set points(t) {
          (this._points = t),
        ...
        interpolate(t, e) {
          let i,
            ...
            r = t[e],
            o = this.points,
            l = (0, s.ao)(this, { property: e, start: r, end: r });
          if (!l.length) return;
          let h = [],
            d = n.stepped
              ? s.ap
      ...
      function ep(t, e) {
        ...
        for (let { source: e, target: h, start: d, end: c } of (function (
          ...
          for (let t of a) {
            ...
            for (let a of (0, s.ao)(e, h)) {
              let e = el(i, r[a.start], r[a.end], a.loop);
              for (let r of (0, s.ay)(t, n, e))
                o.push({
                  source: r,
                  target: a,
        ...
        _fitCols(t, e, i, s) {
          ...
          return (
            this.legendItems.forEach((t, n) => {
              var f, m, x, b, _, v, y, M, k, w, S, P;
              let D,
                C,
                { itemWidth: E, itemHeight: L } =
                  ((f = i),
                  (m = e),
                  (x = a),
                  (b = t),
                  (_ = s),
                  {
                    itemWidth:
                      ...
                      y + M.size / 2 + k.measureText(D).width),
                    itemHeight:
                      ((w = _),
                      (S = b),
                      (P = m.lineHeight),
                      (C = w),
                      "string" != typeof S.text && (C = e_(S, P)),
                      C),
                  });
              n > 0 &&
                u + L + 2 * r > h &&
                ...
                p++,
                (c = u = 0)),
                (o[n] = { left: g, top: u, col: p, width: E, height: L }),
                (c = Math.max(c, E)),
                (u += L + r);
            }),
            (d += c),
              ...
              if (
                ...
                n.beginPath(),
                  Object.values(l).some((t) => 0 !== t)
                    ? (0, s.av)(n, { x: o, y: r, w: p, h: f, radius: l })
                    : n.rect(o, r, p, f),
                  n.fill(),
                  0 !== a && n.stroke();
              }
      ...
      class ey extends tf {
        ...
        _drawArgs(t) {
          let e,
            i,
            a,
            { top: n, left: r, bottom: o, right: l, options: h } = this,
            d = h.align,
            c = 0;
          return (
            this.isHorizontal()
      ...
      var eM = {
        ...
        _element: ey,
        start(t, e, i) {
          let s = new ey({ ctx: t.ctx, options: i, chart: t });
          J.configure(t, s, i), J.addBox(t, s), (t.titleBlock = s);
        },
        stop(t) {
          let e = t.titleBlock;
      ...
      class eT extends tf {
        ...
        getTitle(t, e) {
          let { callbacks: i } = e,
            ...
            r = [];
          return (r = ew(r, eS(s))), (r = ew(r, eS(a))), (r = ew(r, eS(n)));
        }
        getBeforeBody(t, e) {
          return ew([], eS(eA(e.callbacks, "beforeBody", this, t)));
        }
        getBody(t, e) {
          let { callbacks: i } = e,
            a = [];
          return (
            (0, s.F)(t, (t) => {
              let e = { before: [], lines: [], after: [] },
                s = eL(i, t);
              ew(e.before, eS(eA(s, "beforeLabel", this, t))),
                ew(e.lines, eA(s, "label", this, t)),
                ew(e.after, eS(eA(s, "afterLabel", this, t))),
                a.push(e);
            }),
            a
          );
        ...
        getAfterBody(t, e) {
          return ew([], eS(eA(e.callbacks, "afterBody", this, t)));
        }
        getFooter(t, e) {
          let { callbacks: i } = e,
        ...
        update(t, e) {
          let i,
            ...
            n = [];
          if (a.length) {
            let t = ek[s.position].call(this, a, this._eventPosition);
        ...
        _drawColorBox(t, e, i, a, n) {
          ...
          if (n.usePointStyle) {
            ...
            let e = a.leftForLtr(u, h),
              ...
              o = (0, s.ax)(r.borderRadius);
            Object.values(o).some((t) => 0 !== t)
              ? (t.beginPath(),
                (t.fillStyle = n.multiKeyBackground),
                (0, s.av)(t, { x: e, y: p, w: h, h: l, radius: o }),
                t.fill(),
                t.stroke(),
                (t.fillStyle = r.backgroundColor),
                t.beginPath(),
                (0, s.av)(t, { x: i, y: p + 1, w: h - 2, h: l - 2, radius: o }),
                t.fill())
              : ((t.fillStyle = n.multiKeyBackground),
                t.fillRect(e, p, h, l),
        ...
        drawBody(t, e, i) {
          ...
          (_ = 0), (b = x.lineHeight), (0, s.F)(this.afterBody, y), (t.y -= c);
        }
        drawFooter(t, e, i) {
          let a,
            n,
      ...
      function eN(t, e, { horizontal: i, minRotation: a }) {
        let n = (0, s.t)(a),
            ...
            a = (function (t, e) {
              ...
              (r = Math.ceil(v / S) - Math.floor(_ / S)) > b &&
                ...
                y && M && h && (0, s.aJ)((c - d) / h, S / 1e3)
                  ...
                  : ((r = (n - a) / S),
                    (r = (0, s.aK)(r, Math.round(r), S / 1e3)
                      ? Math.round(r)
                      : Math.ceil(r)));
              let P = Math.max((0, s.aL)(S), (0, s.aL)(a));
              (a = Math.round(a * (i = Math.pow(10, (0, s.k)(u) ? P : u))) / i),
                (n = Math.round(n * i) / i);
              let D = 0;
              for (
                y &&
                ...
                let t = Math.round((a + D * S) * i) / i;
                if (M && t > c) break;
                o.push({ value: t });
              }
              return (
                M && m && n !== c
                  ? o.length && (0, s.aK)(o[o.length - 1].value, c, eN(c, w, t))
      ...
      class eq extends eB {
        ...
        generateTickLabels(t) {
          eB.prototype.generateTickLabels.call(this, t),
          ...
          t.display && t.pointLabels.display
            ? (function (t) {
                ...
                for (let c = 0; c < r; c++) {
                  ...
                  a[c] = p;
                  let f = (0, s.az)(t.getIndexAngle(c) + l),
                    ...
                    for (let o = 0; o < r; o++) {
                      ...
                      let r = (function (t, e, i) {
                        ...
                        let c = t.drawingArea,
                          ...
                          x = Math.round((0, s.U)((0, s.az)(m.angle + s.H))),
                          b =
                            ((a = m.y),
                            (n = f.h),
                            90 === (r = x) || 270 === r
                  ...
                  !(function (t, e, i) {
                    ...
                    if (!(0, s.k)(l)) {
                      ...
                      Object.values(i).some((t) => 0 !== t)
                        ? (t.beginPath(),
                          (0, s.av)(t, { x: d, y: c, w: u, h: g, radius: i }),
                          t.fill())
                        : t.fillRect(d, c, u, g);
                    }
                  })(i, r, e);
