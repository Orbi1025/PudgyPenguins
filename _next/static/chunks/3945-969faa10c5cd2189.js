          ...
          (t.prototype.init = function (e) {
            ...
            var ev,
              ...
              eH = function (e, t) {
                eh &&
                  !ew &&
                  ((ek.axis = ew = Math.abs(e) > Math.abs(t) ? "x" : "y"),
                  (e_ = !0)),
                  "y" !== ew && ((eY[2] += e), ek._vx.update(e, !0)),
                  "x" !== ew && ((eI[2] += t), ek._vy.update(t, !0)),
                  x ? ev || (ev = requestAnimationFrame(ez)) : ez();
              },
              eL = function (e) {
                if (!eX(e, 1)) {
                  ...
                  (ek.x = t),
                    ...
                    (a ||
                      ...
                      ((ey = a ? 2 : 1), a || (ek.isDragging = !0), eH(i, o));
                }
              },
      ...
      var L,
        ...
        tI = function (e, t) {
          if (
            ...
            return void tl(t0, "scrollEnd", tC);
          tD(),
          ...
          if ((d && ((s[d] = e || -0.001), e < 0 && (e = 0)), o)) {
            ...
            (h = "scroll" + n.d2),
              tv(
                ...
                n,
                (T && k > 20) ||
                  (!T && (u ? Math.max(G[h], V[h]) : o.parentNode[h]) <= k + 1)
              ),
              u &&
                ((l = tn(a)),
            ...
            (e.prototype.init = function (t, r) {
              ...
              if (
                ...
                eN &&
                  ...
                  (Q = ej((Q = eN.duration || { min: 0.1, max: 2 }))
                    ? $(Q.min, Q.max)
                    : $(Q, Q)),
                  (er = L.delayedCall(eN.delay || K / 2 || 0.1, function () {
                    var e = tI(),
                      t = eS() - tD < 500,
                      n = o.tween;
                    if (
              ...
              if (
                ...
                (tS.revert = function (e, t) {
                  ...
                  n !== tS.isReverted &&
                    (n &&
                      ((ei = Math.max(tI(), tS.scroll.rec || 0)),
                      (tY = tS.progress),
                      (eo = r && r.progress())),
                    p &&
                ...
                (tS.refresh = function (n, i, a, s) {
                  if ((!ee && tS.enabled) || i) {
                    if (ey && n && eM) return void tl(e, "scrollEnd", tC);
                    !ek && tP && tP(tS),
                      (ee = tS),
                    ...
                    if (
                      ...
                      (y = f - u || ((u -= 0.01) && 0.001)),
                      J &&
                        (tY = L.utils.clamp(0, 1, L.utils.normalize(u, f, ei))),
                      (tS._pinPush = et),
                      p &&
                        Q &&
                        (((v = {})[e0.a] = "+=" + Q),
                    ...
                    F &&
                      ...
                      (tS.end = f),
                      (l = c = ek ? ei : tI()),
                      eq || ek || (l < ei && tI(ei), (tS.scroll.rec = 0)),
                      tS.revert(!1, !0),
                      (tD = eS()),
          ...
          return (
            ...
            (e.onChange = function (e, t, r, i, o) {
              if (
                ...
                t &&
                  u &&
                  b(S(i[2] === t ? a + (e.startX - e.x) : b() + t - i[1])),
                r)
              ) {
                y.offset && O();
                var l = o[2] === r,
