    ...
    24251: (t, e, i) => {
      ...
      var o = class {
        ...
        c = class {
          ...
          constructor({
            ...
            (window.lenisVersion = "1.3.1"),
              ...
              (this.dimensions = new r(t, e, { autoResize: w })),
          ...
          checkNestedScroll(t, { deltaX: e, deltaY: i }) {
            ...
            if (
              ...
              return !1;
            if ("x" === p)
              (u = t.scrollLeft), (d = l - a), (m = e), (v = s), (f = r);
            else {
              if ("y" !== p) return !1;
              (u = t.scrollTop), (d = h - c), (m = i), (v = o), (f = n);
            }
            return (m > 0 ? u < d : u > 0) && v && f;
          }
          get rootElement() {
        ...
        v = (0, p.forwardRef)((t, e) => {
          let {
            ...
            a = (0, p.useRef)(null),
            v = (0, p.useRef)(null),
            [f, w] = (0, p.useState)(void 0);
          (0, p.useImperativeHandle)(
            e,
            () => ({ wrapper: a.current, content: v.current, lenis: f }),
            [f]
          ),
            (0, p.useEffect)(() => {
              var t;
              let e = new c({
                ...o,
                ...(!s && { wrapper: a.current, content: v.current }),
                autoRaf: null != (t = null == o ? void 0 : o.autoRaf) ? t : n,
              });
              return (
                w(e),
                () => {
          ...
          let S = (0, p.useRef)([]),
            g = (0, p.useCallback)((t, e) => {
              S.current.push({ callback: t, priority: e }),
          ...
          return (
            (0, p.useEffect)(() => {
              if (s && f)
                return (
                  m.set({ lenis: f, addCallback: g, removeCallback: y }),
                  () => m.set(null)
                );
            }, [s, f, g, y]),
            (0, p.useEffect)(() => {
              ...
              let t = (t) => {
                for (let i = 0; i < S.current.length; i++) {
                  var e;
                  null == (e = S.current[i]) || e.callback(t);
                }
              };
              return (
                f.on("scroll", t),
            ...
            (0, u.jsx)(d.Provider, {
              value: { lenis: f, addCallback: g, removeCallback: y },
              children: s
                ? i
                : (0, u.jsx)("div", {
                    ref: a,
                    ...
                    style: l,
                    ...h,
                    children: (0, u.jsx)("div", { ref: v, children: i }),
                  }),
            })
          );
        }),
      ...
      function w(t) {
        ...
        let i =
          ...
          o = (0, p.useContext)(d),
          r = (function (t) {
            let [e, i] = (0, p.useState)(t.get());
            return (0, p.useEffect)(() => t.subscribe((t) => i(t)), [t]), e;
          })(m),
          {
            lenis: n,
            addCallback: l,
            removeCallback: h,
          } = null != (e = null != o ? o : r) ? e : f;
        return (
          (0, p.useEffect)(() => {
            if (t && l && h && n)
              return (
